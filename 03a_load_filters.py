...
dbutils.widgets.dropdown("replace_existing", "false", ["true", "false"], "Replace Existing Filters")
...
create_filters_raw = [
    # Dashboards
    ["dashboards_create", "dashboards", "createDashboard", "dashboard", "request_params.dashboard_id", "request_params.dashboard_id", "DELETE_RESOURCE", {}, True, "Dashboard creation"],
    ["dashboards_clone", "dashboards", "cloneDashboard", "dashboard", "request_params.new_dashboard_id", "request_params.new_dashboard_id", "DELETE_RESOURCE", {}, True, "Dashboard clone"],
    
    # Genie Space
    ["genie_space_create", "aibiGenie", "createSpace", "genieSpace", 'get_json_object(response.result, "$.space_id")', 'get_json_object(response.result, "$.space_id")', "DELETE_RESOURCE", {}, True, "AI/BI Genie Space creation"],
    
    # Alerts - Note: response.result contains the created alert details
    ["alerts_api_create", "alerts", "apiCreateAlert", "alert", 'COALESCE(get_json_object(response.result, "$.id"), request_params.alert_id)', 'COALESCE(get_json_object(response.result, "$.display_name"), get_json_object(response.result, "$.name"))', "DELETE_RESOURCE", {}, True, "Alert creation via API"],
    ["alerts_create", "alerts", "createAlert", "alert", 'COALESCE(get_json_object(response.result, "$.id"), request_params.alert_id)', 'COALESCE(get_json_object(response.result, "$.display_name"), get_json_object(response.result, "$.name"))', "DELETE_RESOURCE", {}, True, "Alert creation"],
    ["alerts_sql_create", "databrickssql", "createAlert", "alert", "request_params.alertId", "request_params.alertId", "DELETE_RESOURCE", {}, True, "SQL Alert creation"],
    ...
    ["uc_schema_create", "unityCatalog", "createSchema", "schema", "request_params.name", "request_params.name", "DELETE_RESOURCE", {"catalog_name": "request_params.catalog_name"}, True, "Unity Catalog Schema creation"],
    ["uc_table_create", "unityCatalog", "createTable", "table", "request_params.name", "request_params.name", "DELETE_RESOURCE", {"catalog_name": "request_params.catalog_name", "schema_name": "request_params.schema_name"}, True, "Unity Catalog Table creation"],
    ...
    ["uc_volume_create", "unityCatalog", "createVolume", "volume", "request_params.name", "request_params.name", "DELETE_RESOURCE", {"catalog_name": "request_params.catalog_name", "schema_name": "request_params.schema_name"}, True, "Unity Catalog Volume creation"],
    ["uc_registered_model_create", "unityCatalog", "createRegisteredModel", "ucRegisteredModel", "request_params.name", "request_params.name", "DELETE_RESOURCE", {}, True, "Unity Catalog Registered Model creation"],
...
acl_filters_raw = [
    ...
    ["workspace_acl_change", "workspace", "changeWorkspaceAcl", 
     """CASE 
        ...
        WHEN request_params.aclChangeResourceName LIKE '%.py' THEN 'notebook'
        WHEN request_params.aclChangeResourceName LIKE '%.sql' THEN 'notebook'
        WHEN request_params.aclChangeResourceName LIKE '%.scala' THEN 'notebook'
        WHEN request_params.aclChangeResourceName LIKE '%.r' THEN 'notebook'
        ...
        WHEN request_params.aclChangeResourceName LIKE '%/projects/%' THEN 'repo'
     ...
     "Workspace ACL change (notebooks, folders, dashboards, queries, repos)"],
...
delete_filters_raw = [
    ...
    ["dashboard_schedule_delete", "dashboards", "deleteSchedule", "dashboardSchedule", "request_params.dashboard_id", "request_params.dashboard_id", "REPORT_DELETION", {}, True, "Dashboard schedule deletion"],
    ["dashboard_subscription_delete", "dashboards", "deleteSubscription", "dashboardSubscription", "request_params.dashboard_id", "request_params.dashboard_id", "REPORT_DELETION", {}, True, "Dashboard subscription deletion"],
