...
if workspaceId == "4126527463676543":
    ...
    workspace_configs = [
        {
            'workspace_id': '4782182804791024',
            'workspace_name': 'Prod1 Workspace',
        ...
        },
        {
            ...
            'workspace_name': 'Prod2 Workspace',
