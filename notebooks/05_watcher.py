...
object_changes_query = build_audit_query_from_filters(object_changes_filters, workspace_ids_str, lookback_hours, permission_approved_identities_str, is_permission_change=False, is_delete_event=False, is_entitlement_change=False)
...
if entitlement_query:
    dfs.append(run_violation_query(entitlement_query))
